...
class UAVariable extends base_node_1.BaseNode {
    ...
    checkPrivateFlag(context, permission, accessLevel) {
    ...
    isUserReadable(context) {
        ...
        return this.checkPrivateFlag(context, node_opcua_types_1.PermissionType.Read, node_opcua_data_model_1.AccessLevelFlag.CurrentRead);
    }
    isWritable(context) {
    ...
    isUserWritable(context) {
        ...
        return this.checkPrivateFlag(context, node_opcua_types_1.PermissionType.Write, node_opcua_data_model_1.AccessLevelFlag.CurrentWrite);
    }
    /**
     *
     *
