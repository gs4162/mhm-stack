...
import { BrowseDescription, RelativePathElement, RolePermissionTypeOptions } from "node-opcua-types";
...
export declare class BaseNode extends EventEmitter implements BaseNodePublic {
     ...
     */
    getComponentByName(browseName: QualifiedNameOptions): UAVariablePublic | UAObjectPublic | null;
    getComponentByName(browseName: string, namespaceIndex?: number): UAVariablePublic | UAObjectPublic | null;
    /**
     * retrieve a property by name
     */
    getPropertyByName(browseName: QualifiedNameOptions): UAVariablePublic | null;
    ...
    getMethodByName(browseName: QualifiedNameLike, namespaceIndex?: number): UAMethodPublic | null;
    getWriteMask(): number;
    ...
    writeAttribute(context: SessionContext | null, writeValue: any, callback: (err: Error | null, statusCode?: StatusCode) => void): void;
    fullName(): string;
