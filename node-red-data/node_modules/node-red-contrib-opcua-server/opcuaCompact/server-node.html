...
--> <script type='text/x-red' data-help-name='opcua-compact-server'> <h2>OPC UA Compact Server</h2> <p>
The Compact Server node is an OPC UA server with a programmable address space to build your own information model. The address space is to expand with JS source code based on node-opcua API and OPC UA specification.
</p> The product URI have to be unique if you set some other name as the default is! (default: NodeOPCUA-Server-(port)) 
<p>Default enpoint: opc.tcp://localhost:54840</p> <p>Named enpoint: opc.tcp://localhost:54840/UA/NodeRED/Compact</p> <p>
Default discovery: opc.tcp://localhost:4840/UADiscovery</p> <p>all discovery: opc.tcp://localhost:4840/</p> <h3>Options
</h3> <p>If you need more information about all options read the node-opcua API, please!</p> <p>
The 'Delay Before Init' is to init the server node after some delay.</p> <p>
The 'Shutdown Timeout' is to tell node-opcua the server shutdown timeout.</p> <p>
...
AddressSpace</h3> <p>A function like programming editor to construct your own address space in the server.</p> <h3>
Discovery</h3> <p>
That gives you access to the servers discovery node-opcua parameters. Be sure to have a LDS running if you set LDS instead of HIDDEN.
</p> <p>Set showErrors to get errors from node-opcua on browse.</p> </script> <script type='text/javascript'>
 RED.nodes.registerType("opcua-compact-server", {    category: "opcua",
    color: "#20B2aa",
    defaults: {
      port: {
        value: 54840,
    ...
    icon: "icon.png",
    label: function() {
      return this.name || "Compact-Server";
    },
    labelStyle: function() {
  ...
  }); </script> <script type='text/x-red' data-template-name='opcua-compact-server'>
 <div class='form-row'> <ul style='background:#fff;min-width:600px;margin-bottom:20px' id='node-input-server-tabs'></ul>
 </div> <div id='node-input-server-tabs-content' style='min-height:170px'> <div id='compact-server-tab-settings' 
style='display:none'> <div class='form-row'> <label for='node-input-port'><i class='fa fa-fort-awesom'></i> <span 
data-i18n='opcua-compact-contrib.label.port'></span></label> 
...
for='node-input-endpoint'><i class='icon-tasks'></i> <span data-i18n='opcua-compact-contrib.label.endpoint'></span>
</label> <input type='text' id='node-input-endpoint' placeholder='UA/NodeRED/Compact'> </div> <div class='form-row'> 
<label for='node-input-productUri'><i class='icon-tasks'></i> <span data-i18n='opcua-compact-contrib.label.productUri'>
</span></label> <input type='text' id='node-input-productUri' placeholder='NodeOPCUA-Server-(port)'> </div> <div 
class='form-row'> <label for='node-input-alternateHostname'><i class='fa fa-server'></i> <span 
data-i18n='opcua-compact-contrib.label.alternateHostname'></span></label> <input type='text' 
id='node-input-alternateHostname' placeholder=''> </div> <hr> <div class='form-row'> <label 
for='node-input-delayToInit'><i class='icon-time'></i> <span data-i18n='opcua-compact-contrib.label.delayToInit'></span>
</label> <input type='text' id='node-input-delayToInit' placeholder='1000' style='width:80px'> </div> <div 
class='form-row'> <label for='node-input-serverShutdownTimeout'><i class='icon-time'></i> <span 
data-i18n='opcua-compact-contrib.label.serverShutdownTimeout'></span></label> <input type='text' 
id='node-input-serverShutdownTimeout' placeholder='100' style='width:80px'> </div> <div class='form-row'> <label 
for='node-input-delayToClose'><i class='icon-time'></i> <span data-i18n='opcua-compact-contrib.label.delayToClose'>
</span></label> <input type='text' id='node-input-delayToClose' placeholder='200' style='width:80px'> </div> <div 
...
data-i18n='opcua-compact-contrib.label.isAuditing'></span></label> <input type='checkbox' id='node-input-isAuditing' 
...
data-i18n='opcua-compact-contrib.label.showActivities'></span></label> <input type='checkbox' 
...
data-i18n='opcua-compact-contrib.label.showErrors'></span></label> <input type='checkbox' id='node-input-showErrors' 
style='max-width:30px'> </div> </div> <div id='compact-server-tab-limits' style='display:none'> <div class='form-row'> 
<label for='node-input-maxAllowedSessionNumber'><i class='icon-list'></i> <span 
data-i18n='opcua-compact-contrib.label.maxAllowedSessionNumber'></span></label> <input type='text' 
...
data-i18n='opcua-compact-contrib.label.maxConnectionsPerEndpoint'></span></label> <input type='text' 
...
data-i18n='opcua-compact-contrib.label.maxAllowedSubscriptionNumber'></span></label> <input type='text' 
id='node-input-maxAllowedSubscriptionNumber' placeholder='100' style='width:80px'> </div> <div class='form-row'> <label 
for='node-input-maxNodesPerRead'><i class='icon-list'></i> <span 
data-i18n='opcua-compact-contrib.label.maxNodesPerRead'></span></label> <input type='text' 
id='node-input-maxNodesPerRead' placeholder='1000' style='width:80px'> </div> <div class='form-row'> <label 
for='node-input-maxNodesPerHistoryReadData'><i class='icon-list'></i> <span 
data-i18n='opcua-compact-contrib.label.maxNodesPerHistoryReadData'></span></label> <input type='text' 
id='node-input-maxNodesPerHistoryReadData' placeholder='100' style='width:80px'> </div> <div class='form-row'> <label 
for='node-input-maxNodesPerWrite'><i class='icon-list'></i> <span 
data-i18n='opcua-compact-contrib.label.maxNodesPerWrite'></span></label> <input type='text' 
id='node-input-maxNodesPerWrite' placeholder='1000' style='width:80px'> </div> <div class='form-row'> <label 
for='node-input-maxNodesPerBrowse'><i class='icon-list'></i> <span 
data-i18n='opcua-compact-contrib.label.maxNodesPerBrowse'></span></label> <input type='text' 
id='node-input-maxNodesPerBrowse' placeholder='3000' style='width:80px'> </div> <div class='form-row'> <label 
for='node-input-maxBrowseContinuationPoints'><i class='icon-list'></i> <span 
data-i18n='opcua-compact-contrib.label.maxBrowseContinuationPoints'></span></label> <input type='text' 
id='node-input-maxBrowseContinuationPoints' placeholder='10' style='width:80px'> </div> <div class='form-row'> <label 
for='node-input-maxHistoryContinuationPoints'><i class='icon-list'></i> <span 
data-i18n='opcua-compact-contrib.label.maxHistoryContinuationPoints'></span></label> <input type='text' 
id='node-input-maxHistoryContinuationPoints' placeholder='10' style='width:80px'> </div> </div> <div 
id='compact-server-tab-security' style='display:none'> <div class='form-row'> <!-- SecurityPolicy enum via REST --> 
<label for='node-input-securityPolicy' style='min-width:140px'><i class='fa fa-certificate'></i> <span 
data-i18n='opcua-compact-contrib.label.securityPolicy'></span></label> <ul style='margin-left:80px'> <li>None</li> <li>
...
class='fa fa-key'></i> <span data-i18n='opcua-compact-contrib.label.securityMode'></span></label> <ul 
style='margin-left:80px'> <li>None</li> <li>Sign</li> <li>Sign&Encrypt</li> </ul> </div> <div class='form-row'> <label 
style='min-width:140px'> <i class='fa fa-certificate'></i> <span 
data-i18n='opcua-compact-contrib.label.certificateFiles'></span> </label> </div> <div class='form-row'> <label 
style='min-width:240px'> <i class='fa fa-file'></i> <span data-i18n='opcua-compact-contrib.label.individualCerts'>
</span> <input type='checkbox' id='node-input-individualCerts' style='max-width:30px'> </label> </div> <div 
id='node-config-certFiles'> <hr> <div class='form-row'> <label for='node-input-publicCertificateFile'><i 
class='fa fa-file'></i> <span data-i18n='opcua-compact-contrib.label.publicCertificateFile'></span></label> <input 
...
class='fa fa-file'></i> <span data-i18n='opcua-compact-contrib.label.privateCertificateFile'></span></label> <input 
type='text' id='node-input-privateCertificateFile' placeholder='../certificates/server_key_2048.pem' 
style='min-width:480px;width:100%'> </div> <hr> </div> <div class='form-row'> <label for='node-input-allowAnonymous' 
style='min-width:140px'><i class='icon-lock'></i> <span data-i18n='opcua-compact-contrib.label.allowAnonymous'></span>
</label> <input type='checkbox' id='node-input-allowAnonymous' style='max-width:35px'> </div> </div> <div 
id='compact-server-tab-users' style='display:none'> <h4><span data-i18n='opcua-compact-contrib.label.users'></span></h4>
...
class='fa fa-plus'></i> <span data-i18n='opcua-compact-contrib.label.addButton'></span></a> </div> <h4><span 
data-i18n='opcua-compact-contrib.label.xmlsets'></span></h4> <div 
...
style='margin-top:4px'><i class='fa fa-plus'></i> <span data-i18n='opcua-compact-contrib.label.addButton'></span></a> 
</div> </div> <div id='compact-server-tab-ass' style='display:none'> <div class='form-row' style='margin-bottom:0'> 
<label for='node-input-addressSpaceScript' style='width:50%'><i class='fa fa-wrench'></i> <span 
data-i18n='opcua-compact-contrib.label.function'></span></label> <input type='hidden' 
id='node-input-addressSpaceScript'> </div> <div class='form-row node-text-editor-row' id='div-script-editor'> <div 
style='height:350px;min-height:150px' class='node-text-editor' id='node-input-func-editor-addressSpaceScript'></div> 
</div> </div> <div id='compact-server-tab-discovery' style='display:none'> <div class='form-row'> 
<!-- SecurityPolicy enum via REST --> <label for='node-input-registerServerMethod' style='min-width:160px'><i 
class='fa fa-discover'></i> <span data-i18n='opcua-compact-contrib.label.registerServerMethod'></span></label> <select 
...
<span data-i18n='opcua-compact-contrib.label.serverDiscovery'></span></label> <input type='checkbox' 
...
data-i18n='opcua-compact-contrib.label.discoveryServerEndpointUrl'></span></label> <input type='text' 
...
data-i18n='opcua-compact-contrib.label.capabilitiesForMDNS'></span></label> <input type='text' 
id='node-input-capabilitiesForMDNS' placeholder='NA,DA,...'> </div> </div> </div> </script> 